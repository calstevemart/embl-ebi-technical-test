!function () {
    ...
    renderlabels: function (t) { if (this.opts.labels) { var s = this.panel.select("#st-label"); if ("none" === s.style("stroke") || !this.data) return void this.canvas.selectAll(".st-labels").remove(); 
